...
* Create a Jupyter Notebook file called `mission_to_mars.ipynb` which contains all of the scraping and analysis tasks. The following outlines what I scraped.
...
* Use splinter to navigate the site and find the image url for the current Featured Mars Image and assign the url string variable.
